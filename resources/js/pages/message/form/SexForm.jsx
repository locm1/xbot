    ...
    <Card border="0" className="shadow mb-4">
      <Card.Body>
        <Row>
          ...
          <Col xs="auto">
            <h5 className="mb-4 segment-form-title">性別</h5>
          </Col>
        </Row>
        <Form>
          <Row>
            <Col md={12} className="mb-3">
              <CheckboxButton name='sex' id='sex_1' title='男性' value="1" />
              <CheckboxButton name='sex' id='sex_2' title='女性' value="2" />
              <CheckboxButton name='sex' id='sex_3' title='その他' value="3" />
            </Col>
          </Row>
        </Form>
      </Card.Body>
