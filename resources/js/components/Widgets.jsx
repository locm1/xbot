...
export const ProfileCardWidget = (props) => {
  const { first_name, last_name, first_name_kana, last_name_kana, img_path, questionnaireAnswers, area, is_blocked, block_date, id, visitCount, purchaseTime, created_at } = props;
  return (
    <Card border="0" className="shadow text-center p-0">
      ...
      <Card.Body className="pb-5">
        ...
        <div className="py-3">
          <QuestionnaireAnswerForm title="ユーザー情報" createdAt={created_at} questionnaireAnswers={questionnaireAnswers} />
        </div>
      </Card.Body>
    </Card>
  );
  ...
  return (
    <Card className="mb-4 mb-xl-0">
      ...
      <Card.Footer className="border-gray-100 d-grid px-4 pb-4">
        <Button as={Link} variant={variant} to={Paths.Signup.path} target="_blank" className={btnClassName}>
    ...
    <Card border="bottom" className="hover-state rounded-0 rounded-top py-3">
      <Card.Body className="d-flex align-items-center flex-wrap flex-lg-nowrap py-0">
        ...
        <Col xs={10} lg={2} className="ps-0 ps-lg-3 pe-lg-3">
          <Card.Link as={Link} to={Paths.SingleMessage.path} className="d-flex align-items-center">
            {image
              ? (
                <Image
                  src={image}
        ...
        <Col xs={12} lg={7} className="d-flex align-items-center mt-3 mt-lg-0 ps-0">
          <Card.Link as={Link} to={Paths.SingleMessage.path} className="fw-normal text-gray truncate-text">
    ...
    <Card border="bottom" className="hover-state rounded-0 rounded-top py-3">
      <Card.Body className="d-sm-flex align-items-center flex-wrap flex-lg-nowrap py-0">
        ...
        <Col xs={11} lg={10} className="px-0 mb-4 mb-md-0">
          ...
          <div>
            <Card.Link as={Link} to={Paths.SingleMessage.path} className="fw-bold text-dark">
...
export const EventsWidget = () => {
  ...
  return (
    <Card border="0" className="shadow">
      ...
      <Card.Footer as={Link} to={Paths.Calendar.path} className="border-top bg-gray-50">
  ...
  return (
    <Card border="0" className="shadow text-center py-4 mb-4 mb-lg-0">
      <Card.Body>
        ...
        <Button as={Link} variant="secondary" size="sm" to={Paths.Pricing.path}>
          Change plan
        </Button>
      </Card.Body>
    </Card>
