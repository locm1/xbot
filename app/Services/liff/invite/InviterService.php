...
class InviterService 
{
    ...
    public function inviteeJobExists(int $invitee_user_id, int $timing): bool
    {
        $invitee_incentive_user = InviteIncentiveJob::where('invitee_user_id', $invitee_user_id)->first();
        $invitee_timing = InviteIncentiveJob::with('inviteInsentive')->get()->invitee_timing;

        return $invitee_incentive_user && $invitee_timing == $timing;
    }
}